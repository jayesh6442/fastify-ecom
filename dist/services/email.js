...
export async function sendOrderConfirmationEmail(email, orderId, totalCents) {
    return sendEmail({
        to: email,
...
export async function sendOrderPaidEmail(email, orderId) {
    return sendEmail({
        to: email,
...
export async function sendOrderCancelledEmail(email, orderId) {
    return sendEmail({
        to: email,
